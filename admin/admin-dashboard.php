        ...
        <div class="row">
            <div class="admin-nav">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="admin-notes.php" class="list-group-item text-light admin-link"><i class="fas fa-sticky-note"></i>&nbsp;&nbsp;Notes</a>

                    <a href="admin-feedback.php" class="list-group-item text-light admin-link"><i class="fas fa-comment"></i>&nbsp;&nbsp;Feedback</a>

                    <a href="admin-notification.php" class="list-group-item text-light admin-link"><i class="fas fa-bell"></i>&nbsp;&nbsp;Notification</a>

                    <a href="admin-deleteuser.php" class="list-group-item text-light admin-link"><i class="fas fa-user-slash"></i>&nbsp;&nbsp;Deleted Users</a>
